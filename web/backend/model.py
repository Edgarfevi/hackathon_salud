...
class KidneyDiseaseModel:
    ...
    def __init__(self):
        ...
        self.model_path_json = os.path.join(current_dir, "mi_modelo.json")  # XGBoost nativo
        self.metadata_path = os.path.join(current_dir, "model_metadata.pkl")  # Solo metadata
